...
<main class="container page-content">
  <h2 class="page-title">COFFEE</h2>
  <div class="grid" id="grid">
    <div class="card">
      <img src="onig.jpeg" class="card__image" alt="">
      <div class="card__info">
        <h4 class="card__title">ONIGIRI</h4>
        <p class="card__price">RM4</p>
    ...
    <div class="card">
      <img src="onig.jpeg" class="card__image" alt="">
      <div class="card__info">
        <h4 class="card__title">ONIGIRIR</h4>
        <p class="card__price">RM4</p>
